...
AS
BEGIN
  /*IF(NOT EXISTS(SELECT * FROM master.sys.fn_m sys.fn_my_permissions(NULL,'server') AS FMP WHERE FMP.permission_name = 'CONTROL SERVER'))
  BEGIN
  ...
  */
  ...
  RAISERROR('Not working on SQL Azure.',16,10);
  RETURN -1;
END;
